...
class PrescriptionParser(MedicalDocParser):
    ...
    def parse(self):
        ...
        return {
            'Patient': self.get_field('patient_name'),  # Extract patient name
            'Address': self.get_field('patient_address'),  # Extract patient address
...
class PatientDetailsParser(MedicalDocParser):
    ...
    def parse(self):
        ...
        return {
            'Patient': self.get_patient_name(),  # Extract patient name
            'Phone': self.get_patient_phone_number(),  # Extract phone number
            'Problems': self.get_medical_problems(),  # Extract medical problems
            'Hepatitis': self.get_hepatitis_b_vaccination()  # Extract Hepatitis B vaccination status
        }
...
class VrParser(MedicalDocParser):
    ...
    def parse(self):
        ...
        return {
            ...
            'Dates': self.get_dates(),  # Extract dates of doses
            'Gender': self.get_gender(),  # Extract gender
            'Age': self.get_age(),  # Extract age
            'Dosages': self.get_number()  # Extract dosage number
        }
