...
def preprocess_mh(img):
    ...
    img1 = resized[157:199, 34:381]  # Crop the image to get the first ROI
    img2 = resized[157:217, 34:531]
    img3 = resized[231:287, 42:531]  # Crop the image to get the second ROI
    img4 = resized[296:348, 43:360]  # Crop the image to get the third ROI
    img5 = resized[358:419, 39:278]  # Crop the image to get the fourth ROI
    img6 = resized[428:482, 40:265]  # Crop the image to get the fifth ROI
    img7 = resized[494:548, 32:343]  # Crop the image to get the sixth ROI
    img8 = resized[559:610, 34:371]  # Crop the image to get the seventh ROI
    img9 = resized[628:687, 26:261]  # Crop the image to get the eighth ROI
    ...
    img_3 = thresh_adaptive(img3)  # Adaptive thresholding
    img_4 = cv2.adaptiveThreshold(img4, 255, cv2.ADAPTIVE_THRESH_GAUSSIAN_C, cv2.THRESH_BINARY_INV, 11, 6)  # Adaptive thresholding with specific parameters
    img_5 = thresh_adaptive(img5)  # Adaptive thresholding
    img_6 = thresh_global(img6)  # Global thresholding
    img_7 = thresh_global(img7)  # Global thresholding
    img_8 = thresh_adaptive(img8)  # Adaptive thresholding
    img_9 = cv2.adaptiveThreshold(img9, 255, cv2.ADAPTIVE_THRESH_GAUSSIAN_C, cv2.THRESH_BINARY_INV, 23, 24)  # Adaptive thresholding with specific parameters
